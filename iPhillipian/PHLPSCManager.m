...
//wow, I spelled model wrong........
static NSString * const ModelURLString = @"PhillipianDataModal";
static NSString * const StoreURLString = @"PhillipianDataModalPersistentStore.sqlite";


@interface PHLPSCManager ()
...
+ (id)sharedManager{
    static PHLPSCManager *sharedManager = nil;
...
+(NSPersistentStoreCoordinator *)sharedStoreCooridinator{
    ...
    return [[PHLPSCManager sharedManager] sharedPersistentStoreCooridinator];
}
